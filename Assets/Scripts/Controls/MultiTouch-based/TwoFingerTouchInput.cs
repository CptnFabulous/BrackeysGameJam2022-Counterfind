...
public class TwoFingerTouchInput : AdvancedTouchInput
{
    ...
    protected override bool InTouchZone()
    {
        bool finger1 = RectTransformUtility.RectangleContainsScreenPoint(touchZone, newFingerPos1);
        bool finger2 = RectTransformUtility.RectangleContainsScreenPoint(touchZone, newFingerPos2);
